...
//  UploadPhotoAlamofire
//
//  Created by haitham tory on 5/13/16.
//  Copyright © 2016 haitham tory. All rights reserved.
//
...
class ViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBAction func uploadPhotoPressed(sender: AnyObject) {
        ...
        let urlRequest = self.urlRequestWithComponents("http://gorder.com.magenta.mysitehosted.com/Backend/upload.php", parameters: parameters)
